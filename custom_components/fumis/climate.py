...
from .fumis.const import (
    ...
    STATUS_COOLING,
    STATUS_UNKNOWN,
    STATUS_SCHEITHOLZSTART1,
    STATUS_SCHEITHOLZSTART2,
    STATUS_SCHEITHOLZBETRIEB,
)
...
FUMIS_HVAC_TO_HA = {
    ...
    STATUS_SCHEITHOLZSTART1: HVACMode.HEAT,
    STATUS_SCHEITHOLZSTART2: HVACMode.HEAT,
    STATUS_SCHEITHOLZBETRIEB: HVACMode.HEAT,
...
FUMIS_CURRENT_HVAC_TO_HA = {
    ...
    STATUS_SCHEITHOLZSTART1: HVACAction.HEATING,
    STATUS_SCHEITHOLZSTART2: HVACAction.HEATING,
    STATUS_SCHEITHOLZBETRIEB: HVACAction.HEATING,
